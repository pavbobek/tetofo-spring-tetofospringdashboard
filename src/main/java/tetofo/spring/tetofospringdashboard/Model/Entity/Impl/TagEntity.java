...
public class TagEntity implements IEntity {
    ...
    public static final TagEntity JWT = new TagEntity(2l);
    public static final TagEntity MESSAGE = new TagEntity(3l);
    public static final TagEntity PERSISTENCE_FILE = new TagEntity(4l);
    public static final TagEntity RECORD = new TagEntity(5l);
    public static final TagEntity STRING = new TagEntity(6l);
    public static final TagEntity USER = new TagEntity(7l);
    public static final TagEntity USERNAME = new TagEntity(8l);
